  ...
  return (
    ...
    >
      <form className='modelForm d-flex flex-column gap-3' onSubmit={handleModel}>
        <div>
          <label className="fw-semibold mb-1">Group Name</label>
          <input
            type="text"
        ...
        <div>
          <label className="fw-semibold mb-1">Group Username</label>
          <input
            type="text"
            className="form-control"
        ...
        <div>
          <label className="fw-semibold mb-1">Location / Category</label>
          <input
            type="text"
            className="form-control"
        ...
        <div>
          <label className="fw-semibold mb-1">Topic</label>
          <input
            type="text"
            className="form-control"
